    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ManyToManyField(blank=True, null=True, to='maptracking.Categoria', verbose_name='list of Categorias')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='maptracking.Producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='maptracking.Cliente')),
        ...
        migrations.AddField(
            ...
            name='venta',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='maptracking.Venta'),
        ),
        migrations.AddField(
            model_name='producto',
            name='unidad_med',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='maptracking.UnidadMed'),
        ),
    ]
